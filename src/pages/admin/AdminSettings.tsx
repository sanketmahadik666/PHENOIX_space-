          ...
          <CardContent className="space-y-4">
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="email" type="email" defaultValue="admin@elegant.ae" />
              </div>
            </div>
            <div className="space-y-2">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Receive emails for new enquiries</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">Batch Reminders</p>
                <p className="text-sm text-muted-foreground">Get notified before batch starts</p>
              </div>
              <Switch defaultChecked />
            </div>
            <Separator />
